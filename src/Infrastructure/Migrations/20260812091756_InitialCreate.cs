        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGrounded = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "QueryHistorySources",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    QueryHistoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DocumentChunkId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RelevanceScore = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QueryHistorySources", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QueryHistorySources_DocumentChunks_DocumentChunkId",
                        column: x => x.DocumentChunkId,
                        principalTable: "DocumentChunks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QueryHistorySources_QueryHistories_QueryHistoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueryHistorySources_DocumentChunkId",
                table: "QueryHistorySources",
                column: "DocumentChunkId");

            migrationBuilder.CreateIndex(
                name: "IX_QueryHistorySources_QueryHistoryId",
                table: "QueryHistorySources",
